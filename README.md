...
|---|---|---|---|
| **1 · Arquitectura Empresarial** | BMC, modelo de datos, portafolio de apps, ADM/TOGAF | Base de las 3 iniciativas | Completo |
...
| **3 · TO-BE Diseño de Solución** | 2 alternativas, C4 niveles 1-2-3, ADR, comparativo | [`arquitectura/diseno_solucion/`](arquitectura/diseno_solucion/) | Completo |
